...
dict1={"ananya":84,"akshay":56,"rahul":69,"rudra":87,"manish":90}
...
lst = ["ankit","nayana","mayank","george","ananya"]
...
# program to take string as input and change the first occurence with user input
...
# program to take string as input and change all the occurence  of the first character with the user input
...
#program to find mean ,median,mode, mean
